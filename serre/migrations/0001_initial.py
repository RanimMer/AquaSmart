    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='Format supporté: JPG, PNG, GIF. Taille max: 5MB', null=True, upload_to=serre.models.upload_culture_image, verbose_name='Image de la plantation')),
                ('farm', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='plantations', to='users.farm')),
                ('sol', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Plantation', to='sols.analysesol')),
            ],
            options={
